...
class MultipartUploadWrapper extends Client_1.MultipartUpload {
    ...
    uploadFile(filePath_1) {
        return __awaiter(this, arguments, void 0, function* (filePath, options = {}) {
            const { filename = path.basename(filePath), fileType = TwelvelabsApi.CreateAssetUploadRequestType.Video, batchSize = 10, maxWorkers = 5, progressCallback, maxRetries = 3, retryDelay = 1.0, requestOptions, } = options;
